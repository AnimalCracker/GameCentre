...
public class TwentyFourtyEightGameScreen extends GameScreen {
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        g = ((SwipeDetectGridView)gridView).getmController();
    ...
    private void makeNewBoard(){
        ...
        //TODO: fix blankTile and tiles stuff
        gameManager = new TwentyFourtyEightManager(4);
        gameManager.getBoard().addObserver(this);
        System.out.println("THE TIME right after making" + gameManager.getGameState().getTimeElapsed());
